...
const Yoga = () => {
  return (
    <div className="yoga_bg">
      ...
      <section className="section_yoga1">
        ...
        <a href="https://rzp.io/l/nzskN8j" target='_blank'><button className="section_button_med">Start Yoga Classes - Paid Training Program</button></a>
      </section>
      <section className="section_yoga part_section_yoga">
        ...
        <section className="section_yoga program_section_yoga">
          ...
          <div className="program_cards_row_yoga">
            <div className="program_card_yoga">
              <div className="divimg_yoga">
                  ...
                  <h3>Bhujangasana</h3>
                  <p> Nourishes the brain by increasing blood flow to it.Strengthens the arms and legs.Keeps the spine flexible, ensuring participation in a wide range of physical activities.</p>
              </div>
            </div>
            ...
            <div className="program_card_yoga">
              <div className="divimg_yoga">
                  ...
                  <h3>Sukhasana</h3>
                  <p>Tones the arms and leg muscles.Helps improve balance in the body.Increases stamina.</p>
              </div>
            </div>
            ...
            <div className="program_card_yoga">
              <div className="divimg_yoga">
                  ...
                  <p>Tones the arms and legs, Children are able to enjoy physical activities.Increases concentration power and focus, certainly a great help with homework. </p>
              </div>
            </div>
          ...
          <div className="program_cards_row_yoga">
            <div className="program_card_yoga">
              <div className="divimg_yoga">
                  <img src="https://media.newstrack.in/uploads/health-lifestyle/health-tips/Sep/08/big_thumb/health_5d74e8c98ac27.JPG" alt="img" />
                  <h3>Gomukhasana</h3>
                  <p>Strengthens the back muscles. This increases flexibility during play. Helps with posture at the study table. Improves memory.Relaxes the nervous system. This helps overcome issues like stage fright. </p>
              </div>
            </div>
            ...
            <div className="program_card_yoga">
              <div className="divimg_yoga">
                  ...
                  <h3>Trikonasana</h3>
                  <p>Strengthens the arm and leg muscles.Helps relieve stress and fatigue. </p>
              </div>
            </div>

            <div className="program_card_yoga">
              <div className="divimg_yoga">
                  <img src="https://media.istockphoto.com/id/1294274941/photo/fit-adult-woman-lying-on-the-mat-in-shavasana-and-practice-yoga-nidra-the-studio-indoor-side.jpg?s=612x612&w=0&k=20&c=YSAg32vj9PTy2WeD3LbzOiLyJqJg8f2LiluNZB2-llQ=" alt="img" />
                  <h3>Shavasana (Corpse Pose)</h3>
                  <p> Rejuvenates the body. Releases stress and fatigue.Stimulates blood circulation, energizing the body.</p>
              </div>
            </div>
          </div>
